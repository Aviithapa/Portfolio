        ...
        <ul>
            ...
            <li class="start ">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{route('dashboard.news.index')}}">Blog Management</a></li>
...
{{--                    <li><a href="{{route('dashboard.pages.index')}}">Pages Management</a></li>--}}
                    <li><a href="{{route('dashboard.products.index')}}">Portfolio Management</a></li>
                    <li><a href="{{route('dashboard.services.index')}}">Services Management</a></li>
                    <li><a href="{{route('dashboard.skill.index')}}">Skill Management</a></li>
            ...
            <li>
                <a href="{{route('dashboard.gettouch.index')}}">
